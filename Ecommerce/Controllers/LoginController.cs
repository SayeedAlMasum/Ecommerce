...
namespace SkillExchangeMVC.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> CreateLogin(LoginViewModel viewModel)
        {
            ...
            {
                var user = _ecommerceContext.UserInfo.FirstOrDefault(u => u.Email == viewModel.Email);
                if (user != null)
                {
        ...
        public IActionResult ForgotPassword(string email)
        {
            ...
            var user = _ecommerceContext.UserInfo.FirstOrDefault(u => u.Email == email);
            if (user == null)
            {
        ...
        {
            var user = _ecommerceContext.UserInfo.FirstOrDefault(u => u.Email == email && u.PasswordResetToken == token && u.ResetTokenExpires > DateTime.Now);
            if (user == null)
            {
        ...
        public IActionResult ResetPassword(ResetPasswordViewModel model)
        {
            ...
            var user = _ecommerceContext.UserInfo.FirstOrDefault(u => u.Email == model.Email && u.PasswordResetToken == model.Token && u.ResetTokenExpires > DateTime.Now);
            if (user == null)
            {
